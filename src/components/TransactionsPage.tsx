  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Search, filter and review your recent transactions.</p>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-3 md:items-center">
          <div className="relative flex-1">
            <input
              ...
              className="w-full pl-8 pr-3 py-2 rounded-md border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 placeholder:text-gray-400"
            />
          ...
          <div className="flex gap-3">
            <div className="relative">
              ...
              <select
                ...
                className="pl-7 pr-7 py-2 rounded-md border border-gray-300 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
              >
                {categories.map((c) => (
          ...
          <tbody>
            {filtered.map((t) => (
              <tr key={t.id} className="border-t border-gray-100 hover:bg-gray-50/60">
                <td className="px-4 py-3 text-gray-700 whitespace-nowrap">{new Date(t.date).toLocaleDateString()}</td>
                ...
                <td className={`px-4 py-3 text-right font-medium ${t.type === 'income' ? 'text-emerald-600' : 'text-gray-900'}`}>
