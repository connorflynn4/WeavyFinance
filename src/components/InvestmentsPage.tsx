  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-0">
      <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Investments</h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1">Track your portfolio performance and manage your investments.</p>
        </div>
        <div className="flex items-center gap-2 sm:gap-3">
          <button 
            onClick={() => setShowValues(!showValues)}
            className="inline-flex items-center gap-2 rounded-lg border border-gray-300 text-gray-700 px-2 sm:px-3 py-2 text-xs sm:text-sm font-medium hover:bg-gray-50 transition-colors"
          >
            {showValues ? <EyeOff className="w-3 h-3 sm:w-4 sm:h-4" /> : <Eye className="w-3 h-3 sm:w-4 sm:h-4" />}
          ...
          <button 
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-teal-600 text-white px-2 sm:px-3 py-2 text-xs sm:text-sm font-medium hover:bg-teal-700 transition-colors"
          >
        ...
        <div className="bg-white rounded-xl shadow p-3 sm:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-lg sm:text-2xl font-bold ${totalGain >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="bg-white rounded-xl shadow p-3 sm:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-lg sm:text-2xl font-bold ${totalGainPercent >= 0 ? 'text-green-600' : 'text-red-600'}`}>
      ...
      <div className="bg-white rounded-xl shadow p-3 sm:p-4 mb-4 sm:mb-6">
        ...
        <div className="h-48 sm:h-64 bg-gray-50 rounded-lg flex items-center justify-center">
          <div className="text-center text-gray-500">
            <LineChart className="w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-2 text-gray-400" />
            <p className="text-xs sm:text-sm">Performance chart for {selectedTimeframe}</p>
      ...
      <div className="bg-white rounded-xl shadow">
        <div className="p-3 sm:p-4 border-b border-gray-200">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Your Investments</h3>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs sm:text-sm">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Investment</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Type</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Shares</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Price</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">24h Change</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Value</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Gain/Loss</th>
                <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Risk</th>
                ...
                return (
                  <tr key={investment.id} className="hover:bg-gray-50">
                    <td className="px-2 sm:px-4 py-2 sm:py-4">
                      <div>
                        <div className="text-xs sm:text-sm font-medium text-gray-900">{investment.name}</div>
                        <div className="text-xs sm:text-sm text-gray-500">{investment.symbol}</div>
                        {investment.sector && (
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-4 text-xs sm:text-sm text-gray-900">
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-4">
                      <div className={`text-xs sm:text-sm font-medium ${investment.changePercent >= 0 ? 'text-green-600' : 'text-red-600'}`}>
